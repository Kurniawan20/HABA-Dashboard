...
use App\Http\Controllers\absensi\PresenceList;
use App\Http\Controllers\absensi\PresenceStats;

use App\Http\Controllers\absensi\DeviceReset;
use App\Http\Controllers\absensi\PresenceDetail;
use App\Http\Controllers\absensi\BranchManagement;
use App\Http\Controllers\absensi\AttendanceTimeSettings;

use App\Http\Controllers\blog\BlogManagement;
...
// absensi
Route::get('/app/absensi/list', [PresenceList::class, 'index'])->name('app-absensi-list');
Route::get('/app/absensi/stats', [PresenceStats::class, 'index'])->name('app-absensi-stats');
Route::get('/app/absensi/device-reset', [DeviceReset::class, 'index'])->name('app-absensi-device-reset');
Route::get('/app/absensi/detail', [PresenceDetail::class, 'index'])->name('app-absensi-detail');
Route::get('/app/absensi/branches', [BranchManagement::class, 'index'])->name('app-absensi-branches');
Route::get('/app/absensi/time-settings', [AttendanceTimeSettings::class, 'index'])->name('app-absensi-time-settings');

// blog
Route::get('/app/blog/management', [BlogManagement::class, 'index'])->name('app-blog-management');
